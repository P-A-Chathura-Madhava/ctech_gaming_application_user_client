    ...
    <div className="absolute w-screen top-32">
      ...
      >
        <form className="flex flex-col">
          ...
          <button className="block py-2 text-lg text-white border rounded-md border-slate-300 hover:bg-gray-200 hover:text-black">Continue</button>
          <Link href={"/signup"} className="block my-4 text-center text-white hover:text-blue-400">New Game</Link>
        </form>
      </Box>
    </div>
  </>
